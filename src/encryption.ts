...
const mainnetChainIds = new Set(["stateset-1", "stateset-2"]);
const tesetnetChainIds = new Set(["stateset-1-testnet"]);

export class EncryptionUtilsImpl implements EncryptionUtils {
  private readonly registrationQuerier: import("./protobuf_stuff/stateset/registration/v1beta1/query").Query;
  ...
  public constructor(
    registrationQuerier: import("./protobuf_stuff/stateset/registration/v1beta1/query").Query,
    seed?: Uint8Array,
    chainId?: string,
  ) {
