...
export interface Params {
  ...
  statesetFoundationTax: string;
  statesetFoundationAddress: string;
}
...
function createBaseParams(): Params {
  return {
    ...
    statesetFoundationTax: "",
    statesetFoundationAddress: "",
  };
}
...
export const Params = {
  encode(
    ...
    if (message.statesetFoundationTax !== "") {
      writer.uint32(42).string(message.statesetFoundationTax);
    }
    if (message.statesetFoundationAddress !== "") {
      writer.uint32(50).string(message.statesetFoundationAddress);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.statesetFoundationTax = reader.string();
          break;
        case 6:
          message.statesetFoundationAddress = reader.string();
          break;
        default:
  ...
  fromJSON(object: any): Params {
    return {
      ...
      withdrawAddrEnabled: isSet(object.withdrawAddrEnabled)
        ...
        : false,
      statesetFoundationTax: isSet(object.statesetFoundationTax)
        ? String(object.statesetFoundationTax)
        : "",
      statesetFoundationAddress: isSet(object.statesetFoundationAddress)
        ? String(object.statesetFoundationAddress)
        : "",
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.statesetFoundationTax !== undefined &&
      (obj.statesetFoundationTax = message.statesetFoundationTax);
    message.statesetFoundationAddress !== undefined &&
      (obj.statesetFoundationAddress = message.statesetFoundationAddress);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.statesetFoundationTax = object.statesetFoundationTax ?? "";
    message.statesetFoundationAddress = object.statesetFoundationAddress ?? "";
    return message;
  },
};
