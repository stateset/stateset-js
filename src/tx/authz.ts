...
export enum MsgGrantAuthorization {
  ...
  MsgExecuteContract = "/stateset.compute.v1beta1.MsgExecuteContract",
  MsgFundCommunityPool = "/cosmos.distribution.v1beta1.MsgFundCommunityPool",
  MsgGrant = "/cosmos.authz.v1beta1.MsgGrant",
  MsgGrantAllowance = "/cosmos.feegrant.v1beta1.MsgGrantAllowance",
  MsgInstantiateContract = "/stateset.compute.v1beta1.MsgInstantiateContract",
  ...
  MsgStoreCode = "/stateset.compute.v1beta1.MsgStoreCode",
