...
> {
  ...
  registry.set(
    "/stateset.compute.v1beta1.MsgStoreCode",
    (await import("../protobuf_stuff/stateset/compute/v1beta1/msg")).MsgStoreCode,
  );
  registry.set(
    "/stateset.compute.v1beta1.MsgInstantiateContract",
    (await import("../protobuf_stuff/stateset/compute/v1beta1/msg"))
      .MsgInstantiateContract,
  );
  registry.set(
    "/stateset.compute.v1beta1.MsgExecuteContract",
    (await import("../protobuf_stuff/stateset/compute/v1beta1/msg"))
      .MsgExecuteContract,
  );
