...
export class MsgInstantiateContract implements Msg {
  ...
  constructor({
    ...
    if (codeHash) {
      ...
      // codeHash will be set in StatesetNetworkClient before invoking toProto() & toAimno()
      this.codeHash = "";
  ...
  async toProto(utils: EncryptionUtils): Promise<ProtoMsg> {
    ...
    return {
      typeUrl: "/stateset.compute.v1beta1.MsgInstantiateContract",
      value: msgContent,
      encode: async () =>
        (
          await import("../protobuf_stuff/stateset/compute/v1beta1/msg")
...
export class MsgExecuteContract<T extends object> implements Msg {
  ...
  async toProto(utils: EncryptionUtils): Promise<ProtoMsg> {
    ...
    return {
      typeUrl: "/stateset.compute.v1beta1.MsgExecuteContract",
      value: msgContent,
      encode: async () =>
        (
          await import("../protobuf_stuff/stateset/compute/v1beta1/msg")
...
export class MsgStoreCode implements Msg {
  ...
  async toProto(): Promise<ProtoMsg> {
    ...
    return {
      typeUrl: "/stateset.compute.v1beta1.MsgStoreCode",
      value: msgContent,
      encode: async () =>
        (
          await import("../protobuf_stuff/stateset/compute/v1beta1/msg")
